...
exports.sortCategoryColor = function(req,res){
    requestify.request(constant.PRODUCT_SORT_COLOR+req.params.value+'&searchCriteria[filterGroups][0][filters][0][condition_type]=eq',{
        method: 'GET',
        body:{
...
exports.sortCategorySize = function(req,res){
    requestify.request(constant.PRODUCT_SORT_SIZE+req.params.value+'&searchCriteria[filterGroups][0][filters][0][condition_type]=eq',{
        method: 'GET',
        body:{
